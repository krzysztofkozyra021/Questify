    ...
    <div v-if="isLoading" class="fixed inset-0 z-50 flex items-center justify-center bg-stone-900">
      <div class="text-center">
        ...
        <div class="mb-8 animate-bounce">
          <svg class="size-16 mx-auto text-amber-600" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <!-- Main shield shape -->
        ...
        <div class="w-64 h-2 mt-4 bg-stone-800 rounded-full overflow-hidden">
          <div class="h-full bg-amber-600 rounded-full animate-[loading_1s_ease-in-out]" />
        </div>
      </div>
    </div>
  </Transition>
