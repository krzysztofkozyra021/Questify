          ...
          <div class="flex-1 py-2">
            ...
            <div class="flex flex-wrap items-center gap-1 md:gap-2 mt-1">
              <span 
                ...
                class="text-xs font-bold text-stone-600"
              >
                +{{ getTaskExperience(task) }} XP 
              </span>
              <span 
                v-if="task.due_date" 
            ...
            <ul 
              v-if="task.checklist_items && task.checklist_items.length" 
              class="mt-2 ml-2 pl-2 border-l-2" 
              :style="{ borderLeftColor: task.difficulty ? task.difficulty.color : '#57534e' }"
            >
              <li 
                v-for="(item, idx) in task.checklist_items" 
                :key="idx" 
              ...
              >
                <input 
                  ...
                  :style="{ accentColor: task.difficulty ? task.difficulty.color : '#57534e' }" 
                />
