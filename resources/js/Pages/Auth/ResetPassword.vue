...
<template>
  ...
  <div class="min-h-screen bg-stone-900">
    ...
    <!-- Footer -->
    <footer class="bg-stone-900 mt-8 sm:mt-12">
      <div class="container mx-auto px-4 sm:px-6 py-4">
        <div class="flex flex-col items-center justify-center space-y-4">
          <div class="flex space-x-6">
            <a href="https://github.com/krzysztofkozyra021/Questify" target="_blank" class="text-amber-50 hover:text-amber-400 transition-colors">
          ...
          <div class="text-amber-50 text-sm">
