    ...
    <main class="max-w-2xl mx-auto py-4 md:py-6 lg:py-8 px-2 md:px-4">
      ...
      <div class="space-y-4 md:space-y-6 lg:space-y-8">
        ...
        <div class="rounded-lg p-3 md:p-4">
          ...
          <div class="space-y-3 md:space-y-4">
            ...
            <button class="text-sm md:text-base bg-red-500 text-white px-3 md:px-4 py-1.5 md:py-2 rounded font-bold shadow hover:bg-red-600" @click="confirmDeleteAccount">{{ trans('Delete Account') }}</button>
          </div>
        </div>

        <div class="border-t-2 border-stone-400" />
        ...
        <div class="rounded-lg p-3 md:p-4">
          ...
          <div class="space-y-3 md:space-y-4">
            <div>
              <select :value="currentLocale" class="w-full px-2 md:px-3 py-1.5 md:py-2 bg-stone-100 border border-stone-600 rounded-lg text-stone-800 focus:outline-none focus:ring-2 focus:ring-stone-600 text-sm md:text-base" @change="changeLocale">
        ...
        <div class="rounded-lg p-3 md:p-4">
          ...
          <div class="flex items-center gap-3 md:gap-4 mb-3 md:mb-4">
            <img :src="profileImageUrl" alt="Profile" class="size-16 md:size-20 rounded-lg border-2 border-stone-900 bg-white shadow">
          ...
          <div v-if="imagePreview" class="mb-2 flex flex-row gap-3 md:gap-4 items-center">
            <img :src="imagePreview" alt="Preview" class="size-16 md:size-20 rounded-lg border-2 border-stone-900 bg-white shadow">
          ...
          <button :disabled="isUploading" class="bg-stone-600 text-white px-3 md:px-4 py-1.5 md:py-2 rounded font-bold shadow hover:bg-stone-700 disabled:opacity-50 text-sm md:text-base" @click="uploadImage">{{ trans('Upload') }}</button>
        </div>
        ...
        <div class="rounded-lg p-3 md:p-4">
          ...
          <form class="space-y-3 md:space-y-4" @submit.prevent="updatePassword">
            <div>
      ...
      <Modal :show="showDeleteModal" @close="closeDeleteModal">
        <div class="p-4 md:p-6 bg-white rounded-lg">
          ...
          <form class="space-y-3 md:space-y-4" @submit.prevent="deleteAccount">
            <div>
